...
# Runs AFTER Flutter + Android SDK are installed. Scaffolds the Android Flutter app
# in this directory and adds all dependencies. Idempotent-ish; safe to re-run.
# ============================================================================
set -euo pipefail

PROJ_DIR="/home/adithyan/Documents/Tracker_for_paru/androidapp"
...
# flutter create only adds the app skeleton (lib/, android/, pubspec.yaml).
